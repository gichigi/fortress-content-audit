...
export function createMockAuditData(origin: string = 'https://example.com', groupCount: number = 10) {
  ...
  const issueTemplates: Array<{
    ...
    {
      title: "Support misspelt on contact page",
      severity: 'medium',
    ...
    {
      title: "Accommodate typo on multiple pages",
      severity: 'medium',
      impact: 'Reduces credibility and professionalism',
    ...
    {
      title: "Subject-verb disagreement on team page",
      severity: 'medium',
    ...
    {
      title: "Missing apostrophe: 'dont' should be 'don't'",
      severity: 'low',
    ...
    {
      title: "Pricing inconsistency: $29 vs $39",
      severity: 'high',
